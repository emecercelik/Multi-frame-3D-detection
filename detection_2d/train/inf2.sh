...
python inference2.py 	--frozen_graph_path /root_2d_log/train_v7/export/frozen_inference_graph.pb \
			...
			--image_format png \
			--output_path /root_2d_log/validation/train_v7/predictions/t11 \
			--scr_thr 0.0 0.8 0.4 \
			--with_score \
			--save_images 
