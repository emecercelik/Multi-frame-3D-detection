        ...
        with tf.Session(config=cfg) as sess:
            for image_i,image_path in enumerate(image_paths):
                ...
                vis_util.visualize_boxes_and_labels_on_image_array(
                  image_np,
                  output_dict['detection_boxes'][filter_ind],
                ...
                y1 = output_dict['detection_boxes'][:,0] * image.size[1]
                x1 = output_dict['detection_boxes'][:,1] * image.size[0]
                y2 = output_dict['detection_boxes'][:,2] * image.size[1]
                x2 = output_dict['detection_boxes'][:,3] * image.size[0]
                output_dict['detection_boxes'][:,0] = x1
                output_dict['detection_boxes'][:,1] = y1
                output_dict['detection_boxes'][:,2] = x2
                output_dict['detection_boxes'][:,3] = y2
                
                write_predictions_to_file_in_kitti_format(args.output_path,None,args.scr_thr,output_dict['detection_boxes'],\
