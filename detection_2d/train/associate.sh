...
THR='0.6' # IoU threshold that will be used for assigning 
METRIC='dist'
PRED_FOLDER_NAME='train_v6' 
python associate.py 	--path_to_predictions /root_2d_log/validation/$PRED_FOLDER_NAME/predictions \
			...
			--output_images /root_2d_log/validation/$PRED_FOLDER_NAME/predictions_$METRIC/$THR/track_images \
			--output_path /root_2d_log/validation/$PRED_FOLDER_NAME/predictions_$METRIC/$THR/track_labels/0011.txt \
			--with_score \
			--save_images \
